...
export default function Navigator() {
  ...
  return (
    <>
      <nav
        ref={navbarRef}
        className={`fixed left-0 h-full z-20 flex flex-col min-w-[288px] max-md:pb-5 py-9 px-2.5 border-r-gray-200 border-r border-solid transition-all ease-in-out duration-300 bg-white ${
      ...
      <div className="fixed left-4 top-5 z-[15]" ref={navOpenButton}>
        <button
          type="button"
